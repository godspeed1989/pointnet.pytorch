...
from PointSetNet import PointSetCls
...
parser.add_argument('--outf', type=str, default = 'psn_cls',  help='output folder')
...
classifier = PointSetCls(k = num_classes, num_points = opt.num_points)
...
for epoch in range(opt.nepoch):
    ...
    # save per epoch
    torch.save(classifier.state_dict(), '%s/psn_cls_model_%d.pth' % (opt.outf, se+epoch))
